...
-- cross schedules with work time
    ...
    left join ticket_schedules
      on agent_work_time_filtered_statuses.source_relation = ticket_schedules.source_relation
      and agent_work_time_filtered_statuses.ticket_id = ticket_schedules.ticket_id

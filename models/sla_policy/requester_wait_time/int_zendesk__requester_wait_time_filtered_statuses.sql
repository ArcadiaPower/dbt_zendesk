...
--This captures the statuses of the ticket while the requester wait time sla was active for the ticket.
  ...
  join requester_wait_time_sla
    on ticket_historical_status.source_relation = requester_wait_time_sla.source_relation
    and ticket_historical_status.ticket_id = requester_wait_time_sla.ticket_id

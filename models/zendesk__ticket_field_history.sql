...
{% endif %}
    ...
    left join change_data
        on calendar.source_relation = change_data.source_relation
        and calendar.ticket_id = change_data.ticket_id
        and calendar.date_day = change_data.valid_from

    {% if is_incremental() %}
    left join most_recent_data
        on calendar.source_relation = most_recent_data.source_relation
        and calendar.ticket_id = most_recent_data.ticket_id

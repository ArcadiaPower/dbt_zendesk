...
{% endif %}
    ...
    left join ticket_forms
        ...
        and ticket_forms.ticket_form_id = cast(ticket_field_history.ticket_form_id as {{ dbt.type_bigint() }})
    {% endif %}
    ...
    left join group_names
        ...
        and group_names.group_id = cast(ticket_field_history.group_id as {{ dbt.type_bigint() }})
    {% endif %}
    ...
    left join users as assignee
        ...
        and assignee.user_id = cast(ticket_field_history.assignee_id as {{ dbt.type_bigint() }})
    {% endif %}
    ...
    left join users as requester
        ...
        and requester.user_id = cast(ticket_field_history.requester_id as {{ dbt.type_bigint() }})
    {% endif %}
    ...
    left join brands
        ...
        and brands.brand_id = cast(ticket_field_history.brand_id as {{ dbt.type_bigint() }})
    {% endif %}
    ...
    left join organizations
        ...
        and organizations.organization_id = cast(ticket_field_history.organization_id as {{ dbt.type_bigint() }})
    {% endif %}
